...
class Player:
    ...
    def __init__(self):
        ...
        self.hp_bar_low_color = (220, 20, 60)  #
        self.hp_bar_med_color = (255, 165, 0)  #
        self.hp_bar_full_color = (0, 128, 0)     # Green

        # 3 Points of HP (Progress)
        self.hp_bar_progress = [
            1/3 * self.hp_bar_size[0],
            2/3 * self.hp_bar_size[0],
            self.hp_bar_size[0]
        ]
        self.line_width = 2
    ...
    def draw_hp_bar(self):
        ...
        Δinner_pos = 5
        Δinner_size = 9
        inner_pos_1 = (self.hp_bar_pos[0] + Δinner_pos, self.hp_bar_pos[1] + Δinner_pos)
        ...
        inner_size_1 = (1/3 * self.hp_bar_size[0] - Δinner_size, self.hp_bar_size[1] - Δinner_size)
        inner_size_2 = (1/3 * self.hp_bar_size[0] - Δinner_size, self.hp_bar_size[1] - Δinner_size)
        inner_size_3 = (1/3 * self.hp_bar_size[0] - Δinner_size, self.hp_bar_size[1] - Δinner_size)

        pygame.draw.rect(SCREEN, self.hp_bar_low_color, (*inner_pos_1, *inner_size_1), self.line_width)
        pygame.draw.rect(SCREEN, self.hp_bar_med_color, (*inner_pos_2, *inner_size_2), self.line_width)
        pygame.draw.rect(SCREEN, self.hp_bar_full_color, (*inner_pos_3, *inner_size_3), self.line_width)
